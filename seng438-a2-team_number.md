...
# 1 Introduction
In this lab we were given another chance to review and apply the different concepts and practices we covered in lectures, in once again, a very hands-on and interactive approach. Our goal was to learn the basics of automated unit testing based on the requirements of different methods of the system to be tested: JFreeChart. As we were only given the specifications of the classes to be tested and no access to the code we explored the popular criteria based testing technique of black-box using equivalence classes and boundary value analysis. We obtained exposure to Junit, the Java documentation of the system to understand its requirements, and Eclipse to test this given system. Junit was used to create a testing environment which used mock testing and test cases. We were then able to demonstrate the creation of unit tests and using mock objects within our unit test code.
